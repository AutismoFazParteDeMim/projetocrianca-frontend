...
import { Container, StyleItem, StylesContainer, StylesRow, StyleItemImage } from "./styles"
            ...
            {avatar && Platform.OS === "web" ? <svg xmlns={avatar} width={160} height={160} /> : avatar && <SvgXml xml={avatar} width={160} height={160} />}
            {
                categories.map((categoria, index) =>
                    <StylesContainer key={index}>
                        ...
                        <StylesRow>
                            {
                                categoria.colors.map((item, index) =>
                                    <StyleItem key={index} onPress={() => setSeed({
                                        ...seed,
                                        ...
                                        <StyleItemImage source={item.image} />
                                    </StyleItem>
                                )
                            }
                        </StylesRow>
