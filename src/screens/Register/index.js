...
import { createUserWithEmailAndPassword, updateProfile, sendEmailVerification, signInWithCredential, GoogleAuthProvider } from "firebase/auth"
            ...
            <Container behavior={Platform.OS === "ios" ? "padding" : "height"}>
                ...
                <Modal visible={modal.modalVisible} title="Cadastro da Criança" size="medium" closeAction={() => setModal({ ...modal, modalVisible: false })}>
                    <ChildsModalContainer>
                        ...
                        <Button icon="checkmark-circle-outline" title="Concluído" onPress={() => modal.googleSignIn ? signInWithGoogle() : signInWithEmailAndPass()} />
                    </ChildsModalContainer>
                </Modal>
