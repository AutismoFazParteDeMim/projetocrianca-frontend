...
class RegisterPageController extends GetxController with DialogMixin {
  ...
  Future<void> registerWithEmailAndPass() async {
    try {
      final User? userInstance = await repository.registerWithEmailAndPass(
  ...
  Future<void> registerWithGoogle() async {
    final User? userInstance = await repository.loginWithGoogle();
  ...
  Future<void> registerWithFacebook() async {
    final User? userInstance = await repository.loginWithFacebook();
