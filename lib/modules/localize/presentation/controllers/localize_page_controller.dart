...
class LocalizePageController extends GetxController {
  ...
  final Rx<ProfessionalEntity?> _profissional = Rx<ProfessionalEntity?>(null);
  final RxList<ProfessionalEntity?> _professionals =
      RxList<ProfessionalEntity?>(
    [null],
  );
  final RxList<ProfessionalEntity?> _results = RxList<ProfessionalEntity?>(
    [null],
  );
  ...
  ProfessionalEntity? get getProfessional => _profissional.value;
  List<ProfessionalEntity?> get getProfessionals => _professionals;
  List<ProfessionalEntity?> get getResults => _results;

  //setters
  set setShowPinModal(Function value) => _showPinModal = value;
  set setProfessional(ProfessionalEntity value) => _profissional.value = value;
